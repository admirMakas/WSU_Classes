...
nodeDef = [1.5 2.598; 4.5 2.598; 7.5 2.598; 3 0; 6 0; 0 0; 9 0]; %[7 by 2] matrix
elementDef = [1 2; 2 3; 6 4; 4 5; 5 7; 6 1; 1 4; 4 2; 2 5; 5 3; 3 7]; %[11 by 2] matrix 
...
youngM = youngMS.*ones(numEl, 1); %Young's Modulus defined for all 10 elements [11 by 1]
