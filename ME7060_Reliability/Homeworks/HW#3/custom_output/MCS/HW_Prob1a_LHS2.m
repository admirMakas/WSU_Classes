...
%This version of LHS algorithm will use matlab defined function
%called 'lhsdesign(n,p)' to define LHS sampling.
    %here n = # of samples, and p = # of variables
    
%Perform LHS method using 'lhsdesign'
data = lhsdesign(N, NVar);
