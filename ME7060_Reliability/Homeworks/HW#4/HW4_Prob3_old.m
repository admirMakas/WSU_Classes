...
stDev3 = (fullfact([3, 3, 3])-2)*3;

% stDev3 = fracfact('a b c'); % define deesign corner spaces
% stDev3 = [stDev3; 0, 0, 0]*3; %add center point for the design and multiply
%                               by 3 to make it +/- 3 sigma
